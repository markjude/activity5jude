...
//check if the session varaiable are set or merong laman ang session variables or naga exist sila
//this is to check if naka login yung account o hindi man
        ...
        <div class="bg-white shadow rounded overflow-hidden">
            <div class="px-4 pt-0 pb-4 cover">
                <div class="media align-items-end profile-head">
                    <div class="profile mr-3"><img src="images/jude.jpg" alt="..." width="150" class="rounded mb-2 img-thumbnail">
            ...
            <div class="px-4 py-3">
                ...
                <div class="p-4 rounded shadow-sm bg-light">
                    <p class="font-italic mb-0">Data Entry</p>
                    <p class="font-italic mb-0">Advertising</p>
            ...
            <div class="py-4 px-4">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-2 pr-lg-1"><img src="images/back.jpg" alt="" class="img-fluid rounded shadow-sm"></div>              
                    <div class="col-lg-6 mb-2 pl-lg-1"><img src="images/inlove.jpg" alt="" class="img-fluid rounded shadow-sm"></div>                
                    <div class="col-lg-6 pr-lg-1 mb-2"><img src="images/kid.png" alt="" class="img-fluid rounded shadow-sm"></div>
